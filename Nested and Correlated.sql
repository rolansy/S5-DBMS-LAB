...
2 SELECT DISTSQL> SELECT DISTINCT P1.CUST_NO AS CUST_1, P2.CUST_NO AS CUST_2 FROM PURCHASE P1, PURCHASE P2 WHERE (SELECT PRICE FROM PRODUCT WHERE PRODUCT_NO=P2.PROD_NO )<1600 AND (SELECT PRICE FROM PRODUCT WHERE PRODUCT_NO=P1.PROD_NO )<1600 AND P1.CUST_NO <> P2.CUST_NO;
...
6 SQL> SELECT DISTINCT C.NAME FROM CUSTOMER C, PURCHASE P WHERE C.CUST_NO=P.CUST_NO AND P.PROD_NO IN (SELECT PROD_NO FROM PURCHASE WHERE CUST_NO='C00004');
